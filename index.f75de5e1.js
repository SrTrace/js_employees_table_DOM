...
function insertDataToTable(form) {
    ...
    tableHeads.forEach((head)=>{
        ...
        if (inputName === "salary") cellValue = `$${numberFormatter.format(cellValue)}`;
...
function setSortDirection(index) {
    for(let i = 0; i < sortDirections.length; i++)if (i !== index) sortDirections[i] = -1;
